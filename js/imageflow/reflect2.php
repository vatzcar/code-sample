<?php
	...
	*/
		...
		$black = imagecolorallocate($finaloutput, 0, 0, 0);
		imagecolortransparent($finaloutput, $black);
		imagecopymerge($finaloutput, $source, 0, 0, 0, 0, $width, $height,100);
		imagecopymerge($finaloutput, $output, 0, $height, 0, 0, $width, $new_height,100);
		$output = $finaloutput;
